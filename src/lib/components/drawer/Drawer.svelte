...
<button
  ...
  <span
    class="
      lg:1/4 absolute right-2.5 top-1/2 h-1/2 w-1 -translate-y-1/2 animate-pulse
  ...
  <Sidebar asideClass="w-auto">
    <SidebarWrapper divClass="overflow-y-auto py-4 px-3 rounded">
      <SidebarGroup
        ...
        <a
          class="
            ransition select-none
            rounded-full px-4
            py-2 text-2xl tracking-wider
            text-slate-600 duration-200
            ease-in-out hover:bg-gray-500/50 hover:!text-white
            dark:text-slate-400"
