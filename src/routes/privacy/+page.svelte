...
<article
  ...
  <div class="frame readable text-slate-700 dark:text-slate-300">
    <div>
      ...
      <b class="whitespace-nowrap">АО НИЦ «Строительная экспертиза»</b> (далее &mdash; Сайт),
      расположенный на доменном имени <code>stroyexp.info</code>, может получить о Пользователе во
          ...
          <div>
            ...
            <div class="list">
              <div>
                ...
                <b>АО НИЦ «Строительная экспертиза»</b>, которые организуют и (или) осуществляет
