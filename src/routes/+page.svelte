...
<main itemprop="mainContentOfPage">
      ...
      <div class="mr-auto place-self-center lg:col-span-7 2xl:col-span-8">
        <h1
          class="
            dark:text-shadow
            mb-8 text-4xl
            font-extrabold leading-tight text-slate-800 dark:text-slate-200 sm:text-5xl
        ...
        <p
          class="
            xs:text-md mb-4
            text-sm font-light uppercase text-gray-500 dark:text-gray-400 lg:text-lg">
  ...
  <div class="placeholders wrapper-lg">
    <div class="mb-16 grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
      ...
      <TextPlaceholder />
      <Skeleton />
      <TextPlaceholder class="lg:order-last lg:-scale-x-100" />
      <Skeleton class="lg:mr-auto lg:-scale-x-100" />
    </div>
    <TestimonialPlaceholder />
  </div>
</main>
